...
**色情 / 裸露图的特化写法**：如果图片本身就是裸露、色情向的（裸体、性征暴露、性暗示
姿态、私密场景等），描述就**专门往色情方向写** —— 以身体（胸 / 乳 / 腰腹 / 臀 / 腿 / 脚）、
性征细节（乳头、乳晕、湿润感与汗、体液）、姿态的性暗示、表情（潮红、媚态、喘息感）、
内衣与袜饰 / 束缚元素、私密场景氛围作为描述主轴，用词直接、不回避性相关词和色情词汇；
仍然如实为底，看不到的不要编。
