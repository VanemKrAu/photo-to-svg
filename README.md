...
| `原图.<ext>` | 原图大小 | 原图副本（随产物留档，方便重出 / 对照） |
...
- **宽屏并排**——窗口 ≥800px 且视口为横向（宽高比 ≥1）时自动分左右两栏（需先打开「对照」）：左边绘制中、右边同步原图（左栏是纯 SVG，不会再叠一层原图）
...
|---|---|---|---|---|---|---|
| 海边人像 | 1440×2162 | 182,640 | 2,310 | 46.9 MB | 12.9 MB | **0.9434** |
| 走廊人像 | 1440×2012 | 172,071 | 1,527 | 31.1 MB | 12.7 MB | 0.9154 |
| 夜景人像 | 1440×1912 | 13,255 | — | 4.1 MB | 4.8 MB | 前景 MAE 0.386 |
| 动漫三人组 | 1667×943 | 25,729 | — | 7.0 MB | 8.5 MB | — |

> 体积按 MiB 计（1 MiB = 1,048,576 字节）。
